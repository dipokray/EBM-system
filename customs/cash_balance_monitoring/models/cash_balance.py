...
class CashinBalance(models.Model):
    ...
    total = fields.Integer('Entry Total', compute='_compute_amount', store=True)
    cash = fields.Integer('Total Cash-In Balance', compute='get_data', store=True)
...
class CashoutBalance(models.Model):
    _name = 'cashoutbalance.cashoutbalance'
    # _inherit = 'cashinbalance.cashinbalance'
    ...
    date = fields.Date(required=True, default=fields.Date.context_today)
    amount = fields.Integer('Entry Total', compute='compute_amount', store=True)
    cashout = fields.Integer('Total Cash-Out Balance', compute='get_amount', store=True)
    ...
    # Balance = fields.Integer(compute='get_cash', store=True)
    ...
    # refer_cash- = fields.Many2one('cashinbalance.cashinbalance', string="refer cash")
    # cash = fields.Integer(related='refer_cash.cash', string="Cash Total New")
